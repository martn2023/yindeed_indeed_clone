...
from .views import RegisterNewUserView, home_view  # Ensure your views are imported
...
urlpatterns = [
    ...
    path('register/', RegisterNewUserView.as_view(), name='register'),  # URL for the registration view
